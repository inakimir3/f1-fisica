    ...
    return (
      ...
      <main ref={mainRef}  >
        ...
        <section className="relative grid place-items-center h-screen">
            <p className="text-center absolute top-[12%] mx-4 w-fit text-6xl font-bold">La física d'un F1</p>
        ...
        <section className="relative grid place-items-center h-screen">
            ...
            <div className=" absolute bottom-[20%] flex flex-col gap-4 right-[2%] max-w-xl mx-4 w-fit text-xl">
              ...
              <p>
                ...
                Canviar el seu angle modifica el comportament del cotxe en corbes: més càrrega significa més agarri, però també més resistència.
              </p>
              <a href="#" className="flex items-center justify-center px-8 w-fit py-4 text-[16px] mt-4 hover:bg-blue-500 transition-all duration-300 bg-white text-black rounded-full">Conèixer més sobre aerodinàmica, downforce i drag</a>
            </div>    
        </section>
        {/* <div className=" w-full h-[30vh]"></div> */}
